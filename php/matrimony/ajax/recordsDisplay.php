...
function displayPage(){
	  ...
	  $searchValue="";
		for($i=1;$i<=10;$i++) {
			if($search[$i]!="") { 
					...
					if(($i==5)) {
						if($searchValue=="") {
							$searchValue.="FirstName like '%".trim($_REQUEST['searchname'])."%'";
						} else {
							$searchValue.=" AND FirstName like '%".trim($_REQUEST['searchname'])."%'";
						}
					}
					if($i==7) {
	  ...
	  $searchValue="";
		for($i=1;$i<=10;$i++) {
			if($search[$i]!="") { 
					if(($i==1)) {
						if($searchValue=="") {
							$searchValue.="Profile_ID ='".$_REQUEST['verified']."'";
						} 
					}
					if(($i==2)) {
						if($searchValue=="") {
							$searchValue.="Message_Cstatus ='".$_REQUEST['status']."'";
						} else {
							$searchValue.=" AND Message_Cstatus ='".$_REQUEST['status']."'";
						}
					}
					if(($i==5)) {
						if($searchValue=="") {
							$searchValue.="To_profileId ='".trim($_REQUEST['searchname'])."'";
						} else {
							$searchValue.=" AND To_profileId ='".trim($_REQUEST['searchname'])."'";
						}
					}
					if($i==7) {
					if($_REQUEST['fdate']!='' && $_REQUEST['todate']!='' && $_REQUEST['fdate']!=$_REQUEST['todate']) {
						...
						$todatetime = $todate1[2]."-".$todate1[1]."-".$todate1[0]." 59:59:59";
						if($searchValue=="") {
							$searchValue.=" (Message_DOC between '$fromdatetime' AND '$todatetime') ";
						} else {
							$searchValue.=" AND (Message_DOC between '$fromdatetime' AND '$todatetime') ";
						}
					}
					if($_REQUEST['fdate']==$_REQUEST['todate'] && $_REQUEST['fdate']!='') {
						$fmdate = explode("-",$_REQUEST['fdate']);
						$from=$fmdate[2]."-".$fmdate[1]."-".$fmdate[0];
						if($searchValue=="") {
							$searchValue.=" (Message_DOC LIKE '$from%') ";
						} else {
							$searchValue.=" AND (Message_DOC LIKE '$from%') ";
						}
					}
					...
					if(($i==8)) {
						if($searchValue=="") {
							$searchValue.="Profile_ID ='".trim($_REQUEST['userID'])."'";
						} else {
							$searchValue.=" AND Profile_ID ='".trim($_REQUEST['userID'])."'";
						}
					}
				if(($i==9)) {
						if($searchValue=="") {
	...
	if($WebPage=='ManageImage')
	{	
	  $arguments='Profile_ID, Image_ID, Image_Name, Image_Status, Image_DOM, Image_DOA, Image_Priority, Image_Password, Image_autoid, image_thumb, image_small';
	  $page="tm_image";
	  $conditionValue="";
	  $search="";
	  $search=array("1"=>$_REQUEST['verified'],"2"=>$_REQUEST['status'],"3"=>$_REQUEST['sortby'],"4"=>$_REQUEST['sortorder'],"5"=>$_REQUEST['searchname'],"6"=>$_REQUEST['fdate'],"7"=>$_REQUEST['todate'],"8"=>$_REQUEST['userID'],"9"=>$_REQUEST['alpha']);
	  $searchValue="";
		for($i=1;$i<=10;$i++) {
			if($search[$i]!="") { 
					...
					if(($i==2)) {
						if($searchValue=="") {
							$searchValue.="Image_Status ='".$_REQUEST['status']."'";
						} else {
							$searchValue.=" AND Image_Status ='".$_REQUEST['status']."'";
						}
					}
					if(($i==5)) {
						if($searchValue=="") {
							$searchValue.="Image_Name ='".trim($_REQUEST['searchname'])."'";
						} else {
							$searchValue.=" AND Image_Name ='".trim($_REQUEST['searchname'])."'";
						}
					}
					if($i==7) {
					if($_REQUEST['fdate']!='' && $_REQUEST['todate']!='' && $_REQUEST['fdate']!=$_REQUEST['todate']) {
				...
				if(($i==9)) {
						if($searchValue=="") {
							$searchValue.="(Image_Name LIKE '".trim($_REQUEST['alpha'])."%')";	
						} else {
							$searchValue.=" AND (Image_Name LIKE '".trim($_REQUEST['alpha'])."%')";	
						}
					}
				}
			}//FOR
			...
			if(($_REQUEST['sortorder']=="")&&($_REQUEST['sortby']=="")) {
				//$orderBy=" group by Profile_ID order by Image_autoid desc";
				$orderBy=" order by Image_autoid desc";
			} 
			else if(($_REQUEST['sortorder']!="")&&($_REQUEST['sortby']=="")) {
				$orderBy=" order by Image_autoid ".$_REQUEST['sortorder'];
			}
			else if(($_REQUEST['sortorder']=="")&&($_REQUEST['sortby']!="")) {
				$orderBy=" order by ".$_REQUEST['sortby']." desc";
			}
	...
	if($WebPage=='InterestMessage')
	{	
	  $arguments='Int_id, Int_Msg, Int_Type, Int_Status, Int_DOA, Int_DOM';
	  $page="tm_interestmsg";
	  $conditionValue="";
	  $search="";
	  $search=array("1"=>$_REQUEST['verified'],"2"=>$_REQUEST['status'],"3"=>$_REQUEST['sortby'],"4"=>$_REQUEST['sortorder'],"5"=>$_REQUEST['searchname'],"6"=>$_REQUEST['fdate'],"7"=>$_REQUEST['todate'],"8"=>$_REQUEST['userID'],"9"=>$_REQUEST['alpha']);
	  $searchValue="";
		for($i=1;$i<=10;$i++) {
			if($search[$i]!="") { 
					if(($i==1)) {
						if($searchValue=="") {
							$searchValue.="Int_id ='".$_REQUEST['verified']."'";
						} 
					}
					if(($i==2)) {
						if($searchValue=="") {
							$searchValue.="Int_Status ='".$_REQUEST['status']."'";
						} else {
							$searchValue.=" AND Int_Status ='".$_REQUEST['status']."'";
						}
					}
					if(($i==5)) {
						if($searchValue=="") {
							$searchValue.="Int_Type ='".trim($_REQUEST['searchname'])."'";
						} else {
							$searchValue.=" AND Int_Type ='".trim($_REQUEST['searchname'])."'";
						}
					}
					if($i==7) {
					if($_REQUEST['fdate']!='' && $_REQUEST['todate']!='' && $_REQUEST['fdate']!=$_REQUEST['todate']) {
					...
					if(($i==8)) {
						if($searchValue=="") {
							$searchValue.="Int_id ='".trim($_REQUEST['userID'])."'";
						} else {
							$searchValue.=" AND Int_id ='".trim($_REQUEST['userID'])."'";
						}
					}
				if(($i==9)) {
						if($searchValue=="") {
							$searchValue.="(Int_Msg LIKE '".trim($_REQUEST['alpha'])."%')";	
						} else {
							$searchValue.=" AND (Int_Msg LIKE '".trim($_REQUEST['alpha'])."%')";	
						}
					}
				}
			}//FOR
			$search=$searchValue;
			if(($_REQUEST['sortorder']=="")&&($_REQUEST['sortby']=="")) {
				$orderBy="order by Int_id desc";
			} 
			else if(($_REQUEST['sortorder']!="")&&($_REQUEST['sortby']=="")) {
				$orderBy="order by Int_id ".$_REQUEST['sortorder'];
			}
			else if(($_REQUEST['sortorder']=="")&&($_REQUEST['sortby']!="")) {
				$orderBy="order by ".$_REQUEST['sortby']." desc";
			}
	...
	if($WebPage=='ManageUser'){ //echo $search; ?> 
	   ...
	   <? }	if($WebPage=='ManageMessage'){ //echo $search; ?> 
		<table id="paginate_response" class="grid" width="100%" cellpadding="6" cellspacing="1">
		<tbody><tr>
		 	<td class="gridhead" width="10%" align="center">Message ID </td>
			<td class="gridhead" width="10%" align="center">Profile ID </td>
			<td class="gridhead" width="10%" align="center">To profileId</td>
			<td class="gridhead" width="25%" align="center">Message Subject</td>
			<td class="gridhead" width="30%" align="center">Message Content </td>
			<td class="gridhead" width="3%" align="center">Message Status</td>
			<td class="gridhead" width="3%" align="center">Message Cstatus </td>
			<td class="gridhead" width="10%" align="center">Message DOC</td>
			<td class="gridhead" width="10%" align="center">Message DOM</td>
			<td class="gridhead" width="3%" align="center">View</td>
			<td class="gridhead" width="3%" align="center">Edit</td>
			<td class="gridhead" width="3%" align="center">
			<input onClick="javascript:checkall(this.checked);" type="checkbox"></td>
		 ...
		 <? }	if($WebPage=='ManageImage'){ //echo $search; ?> 
		<table id="paginate_response" class="grid" width="100%" cellpadding="6" cellspacing="1">
		<tbody><tr>
			<td class="gridhead" width="5%" align="center">ID </td>
			<td class="gridhead" width="10%" align="center">Profile ID </td>
			<td class="gridhead" width="10%" align="center">Image ID</td>
			<td class="gridhead" width="25%" align="center">Image Name</td>
			<td class="gridhead" width="3%" align="center">Image Status</td>
			<td class="gridhead" width="5%" align="center">Image DOM</td>
			<td class="gridhead" width="5%" align="center">Image DOA </td>
			<td class="gridhead" width="3%" align="center">Image Priority</td>
			<td class="gridhead" width="3%" align="center">View</td>
			<td class="gridhead" width="3%" align="center">Edit</td>
			<td class="gridhead" width="3%" align="center">
			<input onClick="javascript:checkall(this.checked);" type="checkbox"></td>
		...
		<? }	if($WebPage=='InterestMessage'){ //echo $search; ?> 
		<table id="paginate_response" class="grid" width="100%" cellpadding="6" cellspacing="1">
		<tbody><tr>
			<td class="gridhead" width="5%" align="center">ID </td>
			<td class="gridhead" width="30%" align="center">Message </td>
			<td class="gridhead" width="3%" align="center">Type</td>
			<td class="gridhead" width="3%" align="center">Status</td>
			<td class="gridhead" width="5%" align="center">DOA</td>
			<td class="gridhead" width="5%" align="center">DOM</td>
			<td class="gridhead" width="3%" align="center">View</td>
			<td class="gridhead" width="3%" align="center">Edit</td>
			<td class="gridhead" width="3%" align="center">
			<input onClick="javascript:checkall(this.checked);" type="checkbox"></td>
	...
	if ($recordCount10==0) {
		...
		{  
			...
			if($WebPage=='ManageMessage'){
				 $this->Result[$no]['Messages_ID'] =$contentValue[$j]['Messages_ID'];
			...
			if($WebPage=='ManageImage'){//Profile_ID, Image_ID, Image_Name, Image_Status, Image_DOM, Image_DOA, Image_Priority, Image_Content, Image_Password, Image_autoid, image_thumb, image_small
				  $this->Result[$no]['Image_autoid'] =$contentValue[$j]['Image_autoid'];
				 $this->Result[$no]['Profile_ID'] =$contentValue[$j]['Profile_ID'];
				 $this->Result[$no]['Image_ID'] =$contentValue[$j]['Image_ID'];
				 $this->Result[$no]['Image_Name'] =$contentValue[$j]['Image_Name'];
				 $this->Result[$no]['Image_Status'] =$contentValue[$j]['Image_Status'];
				 $this->Result[$no]['Image_DOM'] =$contentValue[$j]['Image_DOM'];
				 $this->Result[$no]['Image_DOA'] =$contentValue[$j]['Image_DOA'];
				 $this->Result[$no]['Image_Priority'] =$contentValue[$j]['Image_Priority'];
			}

				 if($WebPage=='InterestMessage'){
				 $this->Result[$no]['Int_id'] =$contentValue[$j]['Int_id'];
				 $this->Result[$no]['Int_Msg'] =$contentValue[$j]['Int_Msg'];
				 $this->Result[$no]['Int_Type'] =$contentValue[$j]['Int_Type'];
				 $this->Result[$no]['Int_Status'] =$contentValue[$j]['Int_Status'];
				 $this->Result[$no]['Image_Status'] =$contentValue[$j]['Image_Status'];
				 $this->Result[$no]['Int_DOA'] =$contentValue[$j]['Int_DOA'];
				 $this->Result[$no]['Int_DOM'] =$contentValue[$j]['Int_DOM'];
			}
	   ...
	   if($condition == "1") {
		...
		for($i= $arrayStart+1;$i<=$recordCount10;$i++) {
			...
			if($WebPage=='ManageMessage') {
				...
				echo ' <tr class="gridcell" height="55" >
				<td align="center">'.$this->Result[$i]['Messages_ID'].'</td>
				<td align="center">'.$this->Result[$i]['Profile_ID'].'</td>
				<td align="left">'.$this->Result[$i]['To_profileId'].'</td>
				<td>'.$this->Result[$i]['Message_Subject'].'</td>
				<td align="left">	'.$this->Result[$i]['Message_Content'].'</td> 
				<td height="22" align="center" valign="middle" bgcolor="#FEFDDF">'.$this->Result[$i]['Message_Status'].'</td>
				<td align="center">'.$this->Result[$i]['Message_Cstatus'].'</td>				
				<td align="center">'.$this->Result[$i]['Message_DOC'].'</td>
				<td align="center">'.$this->Result[$i]['Message_DOM'].'</td>
				<td align="center"><a href="AddMessage.php?Id='.$this->Result[$i]['Messages_ID'].'&action=view"><img src="../images/edit.gif" border="0"></a></td>
				<td align="center"><a href="AddMessage.php?Id='.$this->Result[$i]['Messages_ID'].'&action=edit"><img src="../images/edit.gif" border="0"></a></td>
				<td align="center"><input name="ad[]" value="'.$this->Result[$i]['Messages_ID'].'" type="checkbox"></td>  </tr>';
			}
			...
			if($WebPage=='ManageImage') {
				...
				echo ' <tr class="gridcell" height="55" >
				<td align="center">'.$this->Result[$i]['Image_autoid'].'</td>
				<td align="center">'.$this->Result[$i]['Profile_ID'].'</td>
				<td align="left">'.$this->Result[$i]['Image_ID'].'</td>
				<td>'.$this->Result[$i]['Image_Name'].'</td>
				<td align="left">	'.$this->Result[$i]['Image_Status'].'</td> 
				<td height="22" align="center" valign="middle" bgcolor="#FEFDDF">'.$this->Result[$i]['Image_DOM'].'</td>
				<td align="center">'.$this->Result[$i]['Image_DOA'].'</td>				
				<td align="center">'.$this->Result[$i]['Image_Priority'].'</td>
				<td align="center"><a href="AddPhoto.php?Id='.$this->Result[$i]['Profile_ID'].'&action=view"><img src="../images/edit.gif" border="0"></a></td>
				<td align="center"><a href="AddPhoto.php?Id='.$this->Result[$i]['Profile_ID'].'&action=edit"><img src="../images/edit.gif" border="0"></a></td>
				<td align="center"><input name="ad[]" value="'.$this->Result[$i]['Image_autoid'].'" type="checkbox"></td>  </tr>';
			}

			if($WebPage=='InterestMessage') {//Int_id, Int_Msg, Int_Type, Int_Type, Int_DOA, Int_DOM
				 if($this->Result[$i]['cs_ActiveStatus'] =='A'){$bgcolor = "style='color:black'";}
				 else if($this->Result[$i]['cs_ActiveStatus']=='I'){$bgcolor = "style='color:blue'";}
				 else if($this->Result[$i]['cs_ActiveStatus']=='B'){$bgcolor = "style='color:red'";}
				echo ' <tr class="gridcell" height="55" >
				<td align="center">'.$this->Result[$i]['Int_id'].'</td>
				<td align="left">'.$this->Result[$i]['Int_Msg'].'</td>
				<td align="center">'.$this->Result[$i]['Int_Type'].'</td>
				<td align="center">'.$this->Result[$i]['Int_Status'].'</td>
				<td align="center">'.$this->Result[$i]['Int_DOA'].'</td> 
				<td height="22" align="center" valign="middle" bgcolor="#FEFDDF">'.$this->Result[$i]['Int_DOM'].'</td>
				<td align="center"><a href="AddInterestMessage.php?Id='.$this->Result[$i]['Int_id'].'&action=view"><img src="../images/edit.gif" border="0"></a></td>
				<td align="center"><a href="AddInterestMessage.php?Id='.$this->Result[$i]['Int_id'].'&action=edit"><img src="../images/edit.gif" border="0"></a></td>
				<td align="center"><input name="ad[]" value="'.$this->Result[$i]['Int_id'].'" type="checkbox"></td>  </tr>';
			}
