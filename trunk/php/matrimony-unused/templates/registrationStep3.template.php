...
<div>
  <div id="register_bg">
		<div  id="head">Registration<span class="step_text">Step - 3</span></div>
			...
			<div class="bg_width" id="age" style="float:left;
 height:105px;
" >
				  <div class="width" >
					<div class="form_31_head" style="width:20%;
">Preferred Age<span class="star"></span></div>
					<div class="form_31_head" style="width:40%;
">Marital Status<span class="star"></span></div>
					<div class="form_31_head">Mother Tongue <span class="star"></span></div>
				  </div>
 				  <div class="width" >
					<div class="form_31" style="height:70px;
 width:20%">
					  <p>
...
">
                    ...
                    <div class="form_31">
                      <select name="ddlmother" class="textfield" id="ddlmother" style="width:100px;
 height:18px;
" onChange="ddlClear('ddlmother','motherError');
gethdmulti('ddlmother','motherHd');
" >
					...
					<div class="width">
						<div class="form_31_red"id="ageError" style="width:20%;
" ><span class="star"></span></div>
						<div class="form_31_red" id="maritalError" style=" width:40%;
"> <span class="star"></span></div>
				   ...
				   <div class="row style1" id="line"></div> <div  class="line_img"> </div>
					...
					<div class="bg_width" id="caste" style="float:left">      
					  <div class="width">
						<div class="form_48_head" style="width:35%;
" >Religion<span class="star"> </span></div>
						<div class="form_48_head" style="width:35%;
">Community<span class="star"></span></div>
...
">
						 <select name="ddlReligion" size="15" multiple="multiple" class="textfield" id="ddlReligion"  style="height:70px;
 width:225px;
" onChange="gethdmulti('ddlReligion','religionHd');
FillCommunity('ddlReligion','ddlCommunity');
ddlClearmulti('ddlReligion','religionError');
">
					 ...
					 <div  class="form_48" style="width:35%;
">
					 	<select name="ddlCommunity" size="15" multiple="multiple" class="textfield" id="ddlCommunity" style="height:70px;
 width:225px;
" onChange="gethdmulti('ddlCommunity','communityHd');
ddlClearmulti('ddlCommunity','communityError');
" >
                	        <option>Select</option>
                      	</select>
					 ...
					 <div class="form_31" style="height:70px;
 width:25%" >
						<input name="txtcaste" id="txtcaste" maxlength="50" type="text"  style="width:155px;
"class="textfield" size="26"> 
					 </div>
		  			</div>
		  
		  			<div class="width">
						<div class="form_48_red" id="religionError" style="width:35%;
"><span class="star"></span></div>
						<div class="form_48_red" id="communityError" style="width:35%;
"><span class="star"></span></div>
						<div class="form_31_red" style="width:25%;
" id="casteError"></div>
		 		    </div>		  
				  </div>
					  <div class="row style1"id="line"></div> <div  class="line_img"> </div>
				    ...
				    <div class="width" id="quql">
						<div class="form_100">
						  <select name="ddle_category" size="15" multiple="multiple" class="textfield" id="ddle_category" style="width:100px;
 height:70px;
 width:175px;
" onChange="gethdmulti('ddle_category','categoryHd');
ddlClearmulti('ddle_category','categoryError');
" >
        		                <option>Select</option>
                	      </select>
...
">
						  <select name="ddlocc" size="15" multiple="multiple" class="textfield" id="ddlocc"  style="width:100px;
 height:70px;
 width:225px;
" onChange="gethdmulti('ddlocc','occHd');
ddlClearmulti('ddlocc','occError');
" >
						    <option>Select</option>
        	              </select>
						...
						<div class="form_48" >
						  <select name="ddlemptype" size="15" multiple="multiple" class="textfield" id="ddlemptype" style="width:100px;
 height:70px;
 width:225px;
" onChange="gethdmulti('ddlemptype','emptypeHd');
">
					    	<option>Select</option>
	                      </select>
				...
				<div class="width" >
					<div class="form_48">
						 <select name="ddlcitizen" size="15" multiple="multiple"  class="textfield" id="ddlcitizen" style="width:100px;
 height:70px;
 width:225px;
" onChange="gethdmulti('ddlcitizen','citizenHd');
ddlClearmulti('ddlcitizen','citizenError');
" >
...
?></option>
					...
					<div class="form_48">
					  <select name="ddlcountry" size="15" multiple="multiple" class="textfield" id="ddlcountry" style="width:100px;
 height:70px;
 width:225px;
" onChange="gethdmulti('ddlcountry','countryHd');
getLocation('',this.value,'','statediv','third','state','');
ddlClearmulti('ddlcountry','countryError');
" >
				  ...
				  <div class="bg_width" id="city" style="float:left">							  
			 	  <div class="width">
					...
					<div class="form_48" id="statediv">
					  <select name="ddlstate" size="1" multiple="multiple" class="textfield" id="ddlstate" style=" height:70px;
 width:225px;
" onChange="gethdmulti('ddlstate','stateHd');
ddlClearmulti('ddlstate','stateError');
" >
					    <option>Select</option>
                      </select>
					</div>
					<div class="form_48" id="citydiv">
					  <select name="ddlcity" size="1" multiple="multiple" class="textfield" id="ddlcity" style="width:100px;
 height:70px;
 width:225px;
" onChange="gethdmulti('ddlcity','cityHd');
ddlClearmulti('ddlcity','cityError');
" >
					    <option>Select</option>
                      </select>
					</div>
					...
					<div class="width">
						...
						<div class="form_48_red" id="cityError"></div>
						  ...
						  <div class="width" id="veg">
							<div class="form_100">
							  <input type="radio" name="rfood" id="foodI" value="Vegetarian" onFocus="setcolor('food');
" />Vegetarian
				  ...
				  <div class="width">
					<div class="form_100">
						  <textarea name="txtabout" id="txtabout" cols="70" style="width:475px;
 height:50px;
" ></textarea>
				    </div>
				  </div>
				  ...
				  <div class="row style1"   id="line"></div> <div  class="line_img"> </div> 
					...
					<div class="bg_width" id="status" style="float:left">
					  ...
					  <div class="width">
							<div class="form_48">
							  <select name="ddlstatus" size="15" multiple="multiple" class="textfield" id="ddlstatus" style=" height:70px;
 width:225px;
" onchange=	"gethdmulti('ddlstatus','statusHd');
ddlClearmulti('ddlstatus','statusError');
" >
	    	                    <option value="0">- Select - </option>
	    	                  </select>
    		                  <input type="hidden" name="statusHd" id="statusHd" value=""/>
						  </div>
							<div class="form_48" style="height:20px;
">From 
							    <select name="ddlfeet" id="ddlfeet" class="textfield" style="width:90px;
 height:18px;
" onChange="ddlClear('ddlfeet','heightError')">
	        		                <option value="0">- Feet/Inch -</option>
    		                  </select> 
							  To
							  <select name="ddlfeet1" id="ddlfeet1" class="textfield" style="width:90px;
 height:18px;
" onChange="ddlClear('ddlfeet1','heightError')">
        		                <option value="0">- Feet/Inch -</option>
                		      </select>
						   </div>
...
"-->
   		       ...
   		       <input type="reset" name="Submit22" value="Reset" id="Submit2"  class="btn" onClick="DIVClear('ageError|maritalError|motherError|religionError|categoryError|occError|citizenError|countryError|stateError|cityError|foodError|aboutError|statusError|heightError');
document.regStepThree.reset();
"/>
	      </div>
...
FillMotherTongues('ddlmother');
FillReligions('ddlReligion');
FillEducations('ddle_category');
FillOccupations('ddlocc');
 FillEmptypes('ddlemptype');
FillPhysicals('ddlstatus');
FillFeet('ddlfeet');
FillFeet('ddlfeet1');
