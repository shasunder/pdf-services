...
$sql = "SELECT * FROM users, user_profile, countries WHERE users.UserID=user_profile.UserID and users.CountryID=countries.CountryID and users.Status=1 and users.ApprovalStatus=1 and users.Gender='Female' order by users.UserID desc limit $eu, $limit";

$sqltot = "SELECT * FROM users, user_profile, countries WHERE users.UserID=user_profile.UserID and users.CountryID=countries.CountryID and users.Status=1 and users.ApprovalStatus=1 and users.Gender='Female' order by users.UserID desc";
