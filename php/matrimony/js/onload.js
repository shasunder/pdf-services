...
var maritalString = "Select|UnMarried|Divorced|Separated|Widow/Widower|Married"		
...
function FillLanguage(ddlControl){
		var languageString = "Select|Assamese|Bengali|Bodo|Dogri|Gujarati|Hindi|Kannada|Kashmiri|Konkani|Maithili|Malayali|Manipuri|Marathi|Marwari|Nepali|Oriya|Parsi|Punjabi|Sanskrit|Santhali|Sindhi|Tamil|Telugu|Urdu|Others"
		document.getElementById(ddlControl).options.length=0
