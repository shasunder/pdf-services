...
<!--
	window.onload = function ()
	{
		...
		{
			if(document.getElementById('gotra-case-div') != null)
			document.getElementById('gotra-case-div').style.display = "none";
			if(document.getElementById('gotra-case-iframe') != null)
			document.getElementById('gotra-case-iframe').style.display = "none";
		}
	}
//-->
</script>
...
<script language="javascript" src="js/profile2.js"></script>
</head>
...
<div style="width: 762px;">
	...
	<div style="border: 0px solid rgb(0, 0, 0); margin: 0pt 30px; text-align: left;">
			...
			<div style="border-bottom: 1px solid rgb(143, 167, 191); padding: 12px 0px 7px; margin-bottom: 10px;">
				<h2><span style="color: rgb(213, 86, 1);">Add more details to your profile...</span></h2>
			</div>
	...
	<form method="post" action="profile2.php" name="profile" id="profile" style="margin: 0px;" onSubmit="return validateform(this);">
	...
	<!-- PROFILE CONTENTS ST -->
		...
		<tbody><tr>
			...
			<select name="bloodgroup" id="bloodgroup" class="field_filled" onfocus="toggleHint('show', 'bloodgroup')" onblur="toggleHint('hide', 'bloodgroup'); checkStyleSelect(this, 'field', 'field_filled');"><option value="">Select</option><option value="Don't Know">Don't Know</option><option value="A+">A+</option><option value="A-">A-</option><option value="B+">B+</option><option value="B-">B-</option><option value="AB+">AB+</option><option value="AB-">AB-</option><option value="O+">O+</option><option value="O-">O-</option></select>
		<!-- HINT STARTS HERE -->
		...
		<tr>
			...
			<td valign="top">
			<select name="annualincome" id="annualincome" class="field_filled" onfocus="toggleHint('show', 'annualincome')" onblur="toggleHint('hide', 'annualincome'); checkStyleSelect(this, 'field', 'field_filled');"><option selected="selected" value="">Select</option><option value="Under Rs.50,000">Under Rs.50,000</option><option value="Rs.50,001 - 1,00,000">Rs.50,001 - 1,00,000</option><option value="Rs.1,00,001 - 2,00,000">Rs.1,00,001 - 2,00,000</option><option value="Rs.2,00,001 - 3,00,000">Rs.2,00,001 - 3,00,000</option><option value="Rs.3,00,001 - 4,00,000">Rs.3,00,001 - 4,00,000</option><option value="Rs.4,00,001 - 5,00,000">Rs.4,00,001 - 5,00,000</option><option value="Rs.5,00,001 - 10,00,000">Rs.5,00,001 - 10,00,000</option><option value="Rs.10,00,001 and above">Rs.10,00,001 and above</option><option></option><option value="Under $25,000">Under $25,000</option><option value="$25,001 - 50,000">$25,001 - 50,000</option><option value="$50,001 - 75,000">$50,001 - 75,000</option><option value="$75,001 - 100,000">$75,001 - 100,000</option><option value="$100,001 - 150,000">$100,001 - 150,000</option><option value="$150,001 - 200,000">$150,001 - 200,000</option><option value="$200,001 and above">$200,001 and above</option></select>
		<!-- HINT STARTS HERE -->
		...
		<tr height="33">
			...
			<td valign="top">
			<input name="contact_details_contact_person" id="contact_details_contact_person" class="field_filled" value="" onkeydown="this.className='field'" onfocus="toggleHint('show', this.name)" onblur="validate_contact_details_contact_person();" type="text">
		<!-- HINT STARTS HERE -->
	...
	<br><span id="errmsg_contact_details_contact_person" class="error"></span>
		...
		<tr height="33">
			...
			<td valign="top">
			<select name="contact_details_relationship" id="contact_details_relationship" class="field_filled" onfocus="toggleHint('show', 'contact_details_relationship')" onblur="validate_contact_details_relationship(this.name);"><option value="">Select</option><option value="Self">Self</option><option value="Parent">Parent</option><option value="Guardian">Guardian</option><option value="Sibling">Sibling</option><option value="Relative">Relative</option><option value="Friend">Friend</option><option value="Other">Other</option></select>
		<!-- HINT STARTS HERE -->
	...
	<br>
		...
		<tr>
			...
			<input class="field_filled" name="contact_details_convenient_time" id="contact_details_convenient_time" value="" size="13" onkeydown="this.className='field'" onfocus="toggleHint('show', this.name)" onblur="validate_contact_details_convenient_time();" type="text">
		<!-- HINT STARTS HERE -->
...
<tbody><tr>
	...
	<td><select name="personal_values" id="personal_values" class="field_filled" onfocus="toggleHint('show', 'personal_values')" onblur="toggleHint('hide', 'personal_values'); checkStyleSelect(this, 'field', 'field_filled');"><option selected="selected" value="">Select</option><option value="Traditional">Traditional</option><option value="Moderate">Moderate</option><option value="Liberal">Liberal</option></select></td>
</tr>
<tr>
...
<!-- CULTURAL BACKGROUND EN -->
		...
		<tbody><tr>
			...
			<td valign="top"><select name="family_father" id="family_father" class="field_filled" onfocus="toggleHint('show', 'family_father')" onblur="validate_select_box(this, 'field_filled', 'field_err');"><option value="">Select</option><option value="Employed">Employed</option><option value="Business">Business</option><option value="Professional">Professional</option><option value="Retired">Retired</option><option value="Not Employed">Not Employed</option><option value="Passed Away">Passed Away</option></select>
		<!-- HINT STARTS HERE -->
	...
	<br>
		...
		<tr>
			...
			<td valign="top">
			<select name="family_mother" id="family_mother" class="field_filled" onfocus="toggleHint('show', 'family_mother')" onblur="validate_select_box(this, 'field_filled', 'field_err');"><option value="">Select</option><option value="Homemaker">Homemaker</option><option value="Employed">Employed</option><option value="Business">Business</option><option value="Professional">Professional</option><option value="Retired">Retired</option><option value="Passed Away">Passed Away</option></select>
		<!-- HINT STARTS HERE -->
	...
	<br>
		...
		<tr>
			...
			<select name="num_of_brother" id="num_of_brother" class="field_filled1" onchange="num_of_siblings_validation('brother')" onfocus="toggleHint('show', 'num_of_brother')" onblur="validate_num_of_brother(this.name);"><option value="">Select</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="2+">2+</option></select>&nbsp; <b>of which married </b>&nbsp;
			<select name="num_of_married_brother" class="field_filled1" onchange="num_of_siblings_validation('brother')" onfocus="toggleHint('show', 'num_of_married_brother')" onblur="validate_num_of_married_brother(this.name);"><option value="">Select</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="2+">2+</option></select>
		<!-- HINT STARTS HERE -->
	...
	<br>
		...
		<tr>
			...
			<td class="td2 smallblack" valign="top">
			<select name="num_of_sister" id="num_of_sister" class="field_filled1" onchange="num_of_siblings_validation('sister')" onfocus="toggleHint('show', 'num_of_sister')" onblur="validate_num_of_sister(this.name);"><option value="">Select</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="2+">2+</option></select>&nbsp; <b>of which married </b>&nbsp;
			<select name="num_of_married_sister" class="field_filled1" onchange="num_of_siblings_validation('sister')" onfocus="toggleHint('show', 'num_of_married_sister')" onblur="validate_num_of_married_sister(this.name);"><option value="">Select</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="2+">2+</option></select>
		<!-- HINT STARTS HERE -->
