                      ...
                      <div class="blue_br">
                        <div class="cls100_p">
		    			 ...
		    			 <?php echo $this->lang->line('remember me');?>
                            ...
                            <p>
                              <input type="button" class="clsMiniBL" value="<?php echo $this->lang->line('Login');?>" name="usersLogin" src="<?php echo image_url('bt_login.png') ;?>" />
							  <input type="hidden" name="usersLogin" value="1" />
                            </p>
                            <p><a href="<?php echo site_url('users/forgotPassword'); ?>"><?php echo $this->lang->line('Forgot Password?');?></a> &nbsp;<b> <a href="<?php echo site_url('buyer/signUp'); ?>"><?php echo $this->lang->line('Sign Up');?></a> </b></p>
						    </form>
                          </div>
                        </div>
                      </div>
