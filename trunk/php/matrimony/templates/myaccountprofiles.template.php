...
<div  class="sch_menu_t1">
		...
		<div class="schmenu_cr">
		  <div class="schmenu">Profile Views</div>
		</div>
...
<tr>
  ...
  <tr><td class="gridcell" align="left"><b>Profile Limit to view : </b></td><td><?php echo $pcount;?></td></tr>
  <tr><td class="gridcell" align="left"><b>No of viewed Profile : </b></td><td><?php echo $vprofile;?></td></tr>
  <tr><td class="gridcell" align="left"><b>No of Profile yet to view : </b></td><td><?php echo $pcount-$vprofile;?></td></tr>
  <tr><td>&nbsp;</td></tr> 
</table>
