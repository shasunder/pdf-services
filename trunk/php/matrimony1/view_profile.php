...
$sql = "SELECT * FROM users, countries, religion WHERE users.CountryID=countries.CountryID and users.ReligionID=religion.ReligionID and users.LoginID='".mysql_escape_string($_REQUEST['id'])."'";
...
<html>
<head>
<title>- <?PHP echo $row['LoginID'] ?>'s Profile</title>
...
<script language="javascript" src="js/viewprofile.js"></script>
...
echo "I am ";
?>
<?PHP echo GetAge($row['BirthYear'], $row['BirthMonth'], $row['BirthDate'])?>, <?PHP echo $row['MaritalStatus']?>, <?PHP echo $row['Religion']?> <?PHP echo $row['Gender']?> living in <?PHP echo $row['State']?>, <?PHP echo $row['Country']?><br>
...
<tr align="left">
	...
	<td valign="top" class="mediumblack">:</td>
	<td valign="top" class="mediumblack"><?PHP echo $row['State']?>, <?PHP echo $row['Country']?></td>
	<td class="mediumblack"><br></td>
</tr>
<tr align="left">
	<td class="mediumblack"><br></td>
