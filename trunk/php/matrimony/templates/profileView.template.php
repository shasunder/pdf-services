...
<div  class="sch_menu_t1">
		...
		<div class="schmenu_cr">
		  <div class="schmenu_highlight" > Full Profile </div>
		</div>
		<div class="schmenu_rt" ></div>
		</div>
<div class="sch_con" > <div class="sch_top">  </div>
<div class="sch_s_head" ><strong> Full Profile </strong></div> 
<div style="height:160px;" ><br /> 
<div class="sch_box"  style="height:150px;">
<div class="prof_full" style="height:122px;">
<? if($myProfile->imgnum != 0 && $myProfile->img_data[0][Image_Status]=='A'){ ?>
<div  class="sch_img" ><a href="imageView.php?pid=<?= $myProfile->profileResult['ProfileId']?>" target="_blank" onClick="window.open(this.href,'newwindow','width=600,height=570,scrollbars=no,resize=0');return false;">
...
<? }else { ?>
    <div style='position:absolute; display:none; z-index:5000;  top:15px;left:110px; width:130px; height:128px; cursor:pointer;' id='show<?= $j;?>'>
...
<div style="height:70px; " ><?= $myProfile->profileResult['AboutMe'];?>  </div>
</div>
...
<div style="height:50px;"> <div class="prof_width_i">
...
<div class="prof_menu_in" id="view5" style="height:inherit;">
<div style="height:inherit;">
<? $myProfile->sendmsg($myProfile->profileId,$_SESSION['ProfileId'],2);
if($myProfile->msgnum>0){ ?>
<div class="search_line"> </div>
<div class="prof_width_i">
 ...
 <div class="search_24_head">Address</div>
 <div class="search_48" style="width:70%; height:60px;"><?= $myProfile->profileResult['Address'];?></div>
 </div>
 <div class="search_line"> </div>
<? } ?>
<div class="prof_width_i">
...
<div class="search_48"><?= $myProfile->profileResult['City'];?></div>
</div>
</div>
</div>
...
<div style="height:80px;"> <div class="prof_width_i">
...
<div class="search_24_head">Sun Sign</div>
<div class="search_24"><?= $myProfile->profileResult['Raasi'];?></div>
</div>
<div class="search_line"> </div>
<div class="prof_width_i">
<div class="search_31_head" style="width:26%;">Chevaai/Kuja/Manglik</div>
<div class="search_48"><?= $myProfile->profileResult['KujaDhosam'];?></div>
</div>
</div>
</div>
...
<div style="height:250px;"> <div class="prof_width_i">
...
<div class="prof_h_b"> <div class="prof_head_i" style="width:162px;">Better-Half Information </div></div>
<div class="prof_menu_in" id="view11" >
<div style="height:650px;"><br />
<div class="prof_width_i">
 <div class="search_24_head">Age</div>
 <div class="search_24"><?= $myProfile->profileResult['pAgeFrom'];?>&nbsp;yrs <strong> - </strong><?= $myProfile->profileResult['pAgeTO'];?>&nbsp;yrs </div>
 ...
 <div class="prof_width_i">
 <div class="search_24_head">Height</div>
 <div class="search_48" style="width:70%;"><?= $myProfile->profileResult['pHeightFrom'];?><strong>&nbsp; - &nbsp;</strong><?= $myProfile->profileResult['pHeightTo'];?></div>
 </div>
 <div class="search_line"> </div>
...
<div style="height:60px;"><?= $myProfile->profileResult['pAboutPartner'];?></div>
</div>
<? } ?>   
<div class="prof_menu_b_a">
<div style="height:15px;text-decoration:none;" align="right"><a href="myProfile.php?page=view&pid=<?= $myProfile->profileResult['ProfileId'];?>" ><img src="images/prof_top_arrow.gif" width="46" height="21" style="border:0px"/></a></div>
</div><br />
</div>
