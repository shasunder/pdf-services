...
<html>
<head>
<title>Marry Banjara - Search By Profession</title>
			...
			<?PHP
				...
				if (@mysql_num_rows($resultCountry)!=0){
					while($rowCountry = mysql_fetch_array($resultCountry))
					{
						...
						<?PHP
						if($_REQUEST['id'] == $rowCountry['ReligionID'])
							echo "selected";
						?>
...
<div class="left graytxt" style="width: 760px;background-image:url(images/background.jpg); height:5px;"></div>
	...
	<table class="left tleft smallcnt graytxt" border="0" cellpadding="0" cellspacing="0"><tr><td>&nbsp;</td></tr></table>
		<table class="left tleft smallcnt graytxt" style="width: 188px;" border="0" cellpadding="0" cellspacing="0">
			<tbody><tr valign="top">
				<td colspan="2" class="titleBrdr" style="background: transparent url(images/title-brdr.gif) repeat-x scroll 0%; line-height: 24px; -moz-background-clip: initial; -moz-background-origin: initial; -moz-background-inline-policy: initial; padding-left:40px; color:#FFFFFF;">Brides</td>
			</tr>
			<?PHP
	$religion = " (user_profile.Profession LIKE '%".$_REQUEST['p']."%') ";
...
from <?PHP echo $row['Country']?></td>
	...
	?>
		<tr>
				<td colspan="2" height="23" valign="bottom"><a href="profession_brides.php?id=<?PHP echo $_REQUEST['p']?>" style="color:#FFFFFF; font-weight:bold;">More Brides...</a></td>
			</tr>
		</tbody></table>
	<?PHP
	}
...
<table class="left tleft smallcnt graytxt" border="0" cellpadding="0" cellspacing="0"><tr><td width="5">&nbsp;</td></tr></table>
...
?><?PHP echo GetAge($row['BirthYear'], $row['BirthMonth'], $row['BirthDate'])?>,<br><?PHP echo $_REQUEST['p']?><br>from <?PHP echo $row['Country']?></td>
	...
	{
	?><tr>
				<td colspan="2" height="23" valign="bottom"><a href="profession_grooms.php?id=<?PHP echo $_REQUEST['p']?>" style="color:#FFFFFF; font-weight:bold;">More Grooms...</a></td>
			</tr>
		</tbody></table>
	<?PHP
	}
