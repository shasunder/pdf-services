...
?>
<select name="ddlstate" id="ddlstate" class="selecttbox_p" style="height:auto;overflow:scroll" onclick="gethdValue('ddlstate','stateVal');" onchange="gethdValue('ddlstate','stateVal');ddlClear('ddlstate','stateError');" onblur="ddlEmptyChk('ddlstate','stateError','Please select the State');">
<? } else {
?>
