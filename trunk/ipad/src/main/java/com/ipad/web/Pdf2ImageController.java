...
public class Pdf2ImageController {
	...
	private static Log logger = LogFactory.getLog(Pdf2ImageController.class);
	final WebHelper webHelper = WebHelper.getInstance();

	PdfService pdfService;

	@RequestMapping("/pdfById.do")
	public ModelAndView getById(HttpServletResponse response) {
		return new ModelAndView("pdf2image/upload-view");
	}

	@RequestMapping("/pdfCreate.do")
