...
$sqlProduct="update interests set AcceptStatus=1 where MessageID=".$_REQUEST['id'];
...
if($rowsettings['smtpstatus'] == 1)
	...
	$mail->Subject = "Your Interest has been Accepted";
	
	$email_layout = "<br><br><img src='".$rowsettings['url']."/images/matrimonial-logo-sm.gif'><br><table border='0' width='100%'><tr><Td colspan='2' background='".$rowsettings['url']."/images/footer_seprator.gif' height='2'></Td></tr></table><br><br><br>Dear ". $row['LoginID'] . ",<br><br>Congratulations! Your Interest has been accepted by ". $row['RecieverID'];
