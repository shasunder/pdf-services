    ...
    <div class="clsMainSettings">
	  ...
	  <div class="clsTitle">
       ...
       <tr>
          ...
          <td class="clsMailIds"><input class="clsTextBox" type="text" name="site_title" value="<?php if(isset($settings['SITE_TITLE'])) echo $settings['SITE_TITLE']; ?>"  readonly />
          <?php echo form_error('site_title'); ?></td></tr>
       <tr>
         <td><?php echo $this->lang->line('website_slogan'); ?><span class="clsRed">*</span></td>
          <td><input class="clsTextBox" type="text" name="site_slogan" value="<?php if(isset($settings['SITE_SLOGAN'])) echo $settings['SITE_SLOGAN']; ?>" readonly/>
          <?php echo form_error('site_slogan'); ?></td></tr>
		  <tr>
         <td><?php echo $this->lang->line('site_url'); ?><span class="clsRed">*</span></td>
          <td><input class="clsTextBox" type="text" name="base_url" value="<?php if(isset($settings['BASE_URL'])) echo $settings['BASE_URL']; ?>" readonly />
          <?php echo form_error('base_url'); ?> </td></tr>
		<tr>
          <td><?php echo $this->lang->line('website_admin_mail'); ?><span class="clsRed">*</span></td>
           <td><input class="clsTextBox" type="text" name="site_admin_mail" value="<?php if(isset($settings['SITE_ADMIN_MAIL'])) echo $settings['SITE_ADMIN_MAIL']; ?>" readonly />
		...
		<tr>
          <td><?php echo $this->lang->line('language code'); ?><span class="clsRed">*</span></td>
           <td><input class="clsTextBox" type="text" name="site_language" value="<?php if(isset($settings['LANGUAGE_CODE'])) echo $settings['LANGUAGE_CODE']; ?>" readonly />
          <?php echo form_error('language_code'); ?></td></tr>  
        <tr> 
		
          <td><?php echo $this->lang->line('website_closed'); ?><span class="clsRed">*</span></td>
           <td><input type="radio"  class="clsRadioBut" name="site_status"  value="1"  <?php if(isset($settings['SITE_STATUS']) and $settings['SITE_STATUS']==1)  echo 'checked="checked"'; ?> disabled />
          <?php echo $this->lang->line('On');?>
          <input type="radio" name="site_status" class="clsRadioBut" value="0"<?php if(isset($settings['SITE_STATUS']) and $settings['SITE_STATUS']==0)  echo 'checked="checked"';   ?> disabled />
